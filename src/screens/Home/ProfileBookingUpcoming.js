...
import ReusableBottomSheetModal from '../../components/FiltersActionSheet';
import ModalComponent from '../../components/FiltersActionSheet';
  ...
  return (
    <ScrollView>
      <View style={{width: '95%', margin: 'auto'}}>
        <Header showArrow={true} label={'Upcoming Bookings'} theme="light" />
      </View>
...
export default ProfileBookingUpcoming;
